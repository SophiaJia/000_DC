    ...
    mainPanel(
      tabsetPanel(type = "tabs",
                  ...
                  tabPanel("Date",
                           ...
                           actionButton("date_exchage", label = "Exchange"),
                           actionButton("date_notshow", label = "Note Show"),
                           actionButton("date_check",   label = "Check Dates"),
